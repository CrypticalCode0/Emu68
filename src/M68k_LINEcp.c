...
uint32_t *EMIT_cpOP(uint32_t *ptr, uint16_t opcode, uint16_t opcode2, uint8_t ext_count, uint16_t **m68k_ptr) {
...
uint32_t *EMIT_FScc_reg(uint32_t *ptr, uint16_t opcode, uint16_t opcode2, uint8_t ext_count, uint16_t **m68k_ptr)__attribute__((alias("EMIT_FScc"));
uint32_t *EMIT_FScc(uint32_t *ptr, uint16_t opcode, uint16_t opcode2, int8_t ext_count, uint16_t **m68k_ptr) {
    ...
    if(cp == cp_FPU) {
        ...
        if ((opcode & 070) == 0) {
            ...
            ptr = EMIT_StoreToEffectiveAddress(ptr, 1, &tmp, opcode & 077, *m68k_ptr, &ext_count, 0);                RA_FreeARMRegister(&ptr, tmp);
        }
...
uint32_t *EMIT_FDBcc(uint32_t *ptr, uint16_t opcode, uint16_t opcode2, int8_t ext_count, uint16_t **m68k_ptr) {
...
uint32_t *EMIT_FTRAPcc(uint32_t *ptr, uint16_t opcode, uint16_t opcode2, int8_t ext_count, uint16_t **m68k_ptr) {
...
uint32_t *EMIT_FNOP(uint32_t *ptr, uint16_t opcode, uint16_t opcode2, int8_t ext_count, uint16_t **m68k_ptr) {
...
uint32_t *EMIT_FBcc(uint32_t *ptr, uint16_t opcode, uint16_t opcode2, int8_t ext_count, uint16_t **m68k_ptr) {
...
uint32_t *EMIT_FSAVE(uint32_t *ptr, uint16_t opcode, uint16_t opcode2, int8_t ext_count, uint16_t **m68k_ptr) {
...
uint32_t *EMIT_FRESTORE(uint32_t *ptr, uint16_t opcode, uint16_t opcode2, int8_t ext_count, uint16_t **m68k_ptr) {
...
static struct FPUOpcodeDef InsnTable[512] = {
  [0000 ... 0074] = { { EMIT_cpOP }, NULL, 0, FPCC, 2, 0, 1},
  ...
  [0172 ... 0174] = { { EMIT_FTRAPcc }, NULL, FPCC, 4, 0, 0},
  [0200]          = { { EMIT_FNOP }, NULL , 0, 0, 2, 0, 0},
  [0201 ... 0377] = { { EMIT_FBcc }, NULL, FPCC, 0, 2, 0, 0},
  [0300 ... 0377] = { { EMIT_FBcc }, NULL, FPCC, 0, 3, 0, 0},
  [0420 ... 0471] = { { EMIT_FSAVE }, NULL, FPSR_ALL, 0, 1, 0, 0},
  [0520 ... 0573] = { { EMIT_FRESTORE }, NULL, 0, FPSR_ALL, 1, 0, 0}
}
...
uint32_t GetSR_LineF(uint16_t opcode)
{
    ...
    if (InsnTable[opcode & 0777].od_Emit) {
        return (InsnTable[opcode & 0777].od_FPSRNeeds) | InsnTable[opcode & 0777].od_FPSRSets;
    }
